            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-category-table-toolbar="base">
                    <button type="button" class="btn btn-primary ps-4" data-bs-toggle="modal"
                        ...
                        <i class="ki-duotone ki-plus fs-2"></i>Tambah Category
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="create-category" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <form class="form" action="#" id="create-category_form">
                    <div class="modal-header" id="create-category_header">
                        <h2 class="fw-bold">Tambah Category</h2>
                        <div id="create-category_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                    ...
                    <div class="modal-footer flex-center">
                        <button type="reset" id="create-category_cancel" class="btn btn-light me-3">
                            Discard
                        </button>
                        <button type="submit" data-category="" id="create-category_submit" class="btn btn-primary">
...
@push('js')
    ...
    {{-- <script src="{{ asset('assets/js/pages/category/create.js') }}"></script> --}}
@endpush
