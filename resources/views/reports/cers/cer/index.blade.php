        ...
        <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted">Asset Request</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="search" name="search" data-kt-asset-table-filter="search"
                        class="form-control form-control-solid w-250px ps-13" placeholder="Cari Asset Request" />
                </div>
            </div>
    ...
    <div class="modal fade" id="filter-asset" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" id="filter-asset_request_header">
                    <h2 class="fw-bold title">Filter Asset Request</h2>
                    <div id="filter-asset_request_close" class="btn btn-icon btn-sm btn-active-light-primary ms-2"
                ...
                <div class="modal-footer flex-center">
                    <button type="reset" id="filter-asset_request_cancel" class="btn btn-light me-3">
                        Batal
                    </button>
                    ...
                    <button type="submit" data-asset="" id="filter-asset_request_submit" class="btn btn-primary ps-4">
                        <span class="indicator-label">
                            <div class="d-flex align-items-center gap-2">
                                <i class="ki-duotone ki-filter fs-2">
                                    <i class="path1"></i>
...
@push('js')
    ...
    <script src="{{ asset('assets/js/pages/reports/cers/cer/index.js') }}"></script>
@endpush
