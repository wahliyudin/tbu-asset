                    ...
                    <div class="card-header border-0">
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-data-asset-table-filter="search" name="search"
                                    class="form-control form-control-solid w-250px ps-13" placeholder="Cari Asset" />
                            </div>
                        </div>
                    </div>
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="data-asset_table">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    <th class="min-w-50px">Actions</th>
                                    <th>Nama Asset</th>
                                    <th>Merk/Tipe/Model</th>
                                    <th>Serial Number Asset</th>
                                    <th>Nomor Asset</th>
                                    <th>Nilai Akuisisi / Nilai Buku</th>
                                    <th>Kelengkapan Asset</th>
                                </tr>
                            </thead>
