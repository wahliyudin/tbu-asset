            ...
            <div class="modal-content">
                <form class="form" action="#" id="create-cluster_form">
                    <div class="modal-header" id="create-cluster_header">
                        <h2 class="fw-bold">Tambah Cluster</h2>
                        <div id="create-cluster_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-select form-select-solid" name="category_id" data-control="select2"
                                ...
                                @foreach ($categories as $category)
                                    <option value="{{ $category->_id }}">{{ $category->_source->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="fv-row mb-7">
