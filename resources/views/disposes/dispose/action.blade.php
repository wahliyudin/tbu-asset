<div class="d-flex align-items-center gap-2">
    @if ($assetDispose->status === \App\Enums\Workflows\Status::DRAFT)
        @permission('asset_dispose_update')
            <a href="{{ route('asset-disposes.edit', $assetDispose->getKey()) }}"
    ...
    @permission('asset_dispose_read')
        <a href="{{ route('asset-disposes.show', $assetDispose->getKey()) }}" class="btn btn-sm btn-warning ps-4 d-flex">
